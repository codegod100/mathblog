...
/**
 * Reusable settings-tab section for AT Protocol OAuth login/logout.
 *
 * Drop this into your plugin's SettingTab.display() method:
 *
 * ```ts
 * const authSection = new AuthSettingsSection(this.app, containerEl, this.auth);
 * authSection.display();
 * ```
 */
